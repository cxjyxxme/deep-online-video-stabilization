...
x_map = graph.get_tensor_by_name("stable_net/inference/SpatialTransformer/_transform/Reshape_144:0")
y_map = graph.get_tensor_by_name("stable_net/inference/SpatialTransformer/_transform/Reshape_145:0")
...
for video_name in video_list:
    ...
    try:
        while(True):
            ...
            img_warped = warpRevBundle2(cv2.resize(frame_unstable, (width, height)), xmap, ymap)
